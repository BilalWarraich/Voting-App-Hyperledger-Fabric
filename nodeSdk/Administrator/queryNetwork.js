  ...
  invokeQuery: async function (request) {
    ...
    try {
      ...
      let user_from_store = await Fabric_Client.newDefaultKeyValueStore({
        ...
        return fabric_client.getUserContext('adminstrator', true);
      });

      if (user_from_store && user_from_store.isEnrolled()) {
        console.log('Successfully loaded adminstrator from persistence');
      } else {
        throw new Error('Failed to get adminstrator.... run registerUserNetwork.js');
      }
